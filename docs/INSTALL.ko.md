...
현재 후보 버전은 **v0.3.1-rc.2**입니다. CLI 버전을 명시하여 업데이트합니다.
...
Unity import가 끝나면 `unity-bridge status`에서 `Connector: 0.3.1-rc.2`을 확인합니다.
CLI 버전은 `unity-bridge update --check --ref v0.3.1-rc.2`로 확인하세요.
